		...
		namespace parallel {
			namespace details {
				...
				bool _Equal_helper(const _ExPolicy&, _InIt _First, _InIt2 _First2, _Diff _Count, _Pr _Pred)
				{
					...
					_Partitioner<_ExecutionPolicy>::_For_Each(make_composable_iterator(_First, _First2), _Count,
						[_Pred, &_Token](details::composable_iterator<_InIt, _InIt2> _Begin, size_t _Count){
