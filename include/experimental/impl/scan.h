	...
	namespace experimental {
		namespace parallel {
			namespace details {
				...
				{
					_EXP_TRY
						return inclusive_scan(_First, _Last, _Dest, _Init, _Op);
					_EXP_RETHROW
				}
			...
			inline typename details::_enable_if_policy<_ExPolicy, _OutIt>::type exclusive_scan(_ExPolicy&& _Policy, _InIt _First, _InIt _Last, _OutIt _Dest)
			{
				return exclusive_scan(_Policy, _First, _Last, _Dest, std::iterator_traits<_InIt>::value_type{}, std::plus<>());
			}

			template<class _ExPolicy, class _InIt, class _OutIt, class _Ty, class _BinOp>
			inline typename details::_enable_if_policy<_ExPolicy, _OutIt>::type inclusive_scan(_ExPolicy&& _Policy, _InIt _First, _InIt _Last, _OutIt _Dest, _Ty _Init, _BinOp _Op)
			{
				static_assert(std::is_base_of<std::input_iterator_tag, typename std::iterator_traits<_InIt>::iterator_category>::value, "Required input iterator or stronger.");
				static_assert(std::is_base_of<std::_Mutable_iterator_tag, typename std::iterator_traits<_OutIt>::iterator_category>::value, "Required output iterator or stronger.");
			...
			template<class _ExPolicy, class _InIt, class _OutIt, class _Ty>
			inline typename details::_enable_if_policy<_ExPolicy, _OutIt>::type inclusive_scan(_ExPolicy&& _Policy, _InIt _First, _InIt _Last, _OutIt _Dest, _Ty _Init)
			{
				return inclusive_scan(_Policy, _First, _Last, _Dest, _Init, std::plus<>());
			}
			...
			{
				return inclusive_scan(_Policy, _First, _Last, _Dest, std::iterator_traits<_InIt>::value_type{}, std::plus<>());
			}
		}
	}
