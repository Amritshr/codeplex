	...
	namespace experimental {
		namespace parallel {
			namespace details
			{
				...
				void parallel_partialsort_impl(const RandomIterator &begin, size_t sortSize, size_t size, const Function &func, size_t _Div_num, const size_t chunkSize, int depth)
				{
...
#pragma warning(pop)
				...
				inline typename _enable_if_parallel<_ExPolicy, void>::type _Sort_impl(const _ExPolicy&, _FwdIt _First, _FwdIt _Last, _Pr _Pred, _IterCat)
				{
					...
					size_t _Core_num = std::thread::hardware_concurrency();
